...
const Municipalbuildings = () => {
  const { data: windpowers, isLoading } = useFetch(
  ...
  return (
    <>
      <Helmet>
        <title>Municipal Building - Smart City Citizen</title>
        <meta charSet="utf-8"/>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.municipalbuildings_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.municipalbuildings_paragraph
          }
